...
var sections = gsap.utils.toArray(".beliefs-items");
...
var navLinksList = document.querySelectorAll(".nav-links__list"); // link list animation

hamburger.addEventListener("click", function () {
  if (hamburger.classList[1] == 'active') {
    hamburger.classList.remove('active');
    console.log('yes');
    var tlnavlist2 = gsap.timeline({
      defaults: {
        ease: 'power4.inOut',
        duration: 2
      }
...
window.onresize = function () {
  if (window.innerWidth > 640) {
    ...
    navLinksList.forEach(function (links) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkclientele_savvy"] = self["webpackChunkclientele_savvy"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/css/style"], function() { return __webpack_require__("./src/css/style.scss"); })
